...
BOOL _bIMEProc = false; // �̱�ȯ ���� 11.12
...
//			_pTimer = new CTimer;
	...
	return _bIMEProc?0:DefWindowProc(hWnd, message, wParam, lParam);  // �̱�ȯ ���� 11.12
}
